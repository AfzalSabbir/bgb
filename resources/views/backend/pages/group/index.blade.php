...
<div class="row">
  <div class="col-xl-12">
    <div class="breadcrumb-holder">
      <h1 class="main-title float-left">{{ __('group.group_management') }}</h1>
      <ol class="breadcrumb float-right">
        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('default.dashboard') }}</a></li>
        <li class="breadcrumb-item active">{{ __('group.group') }}</li>
      </ol>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-md-6"><h2><i class="fa fa-fw fa-bars"> </i>{{ __('group.group') }}</h2></div>
      ...
      <div class="card-body">
        ...
        <div class="toggle-table-column">
          ...
          <a href="#" class="toggle-vis" data-column="2"><b>{{ __('default.photo') }}</b></a> | 
          <a href="#" class="toggle-vis" data-column="3"><b>{{ __('default.status') }}</b></a> | 
          <a href="#" class="toggle-vis" data-column="4"><b>{{ __('default.action') }}</b></a>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{ __('group.add_group') }}</h5>
...
<div class="modal fade" id="edit_page" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{ __('group.update_group') }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<script>
    $(document).ready(function(){
     ...
     // },
     messages: {
       title: "{{ __('default.required_validation') }}",
       photo: "{{ __('default.required_validation') }}",
       status: "{{ __('default.required_validation') }}",
     } 
   });
    });
 </script>
