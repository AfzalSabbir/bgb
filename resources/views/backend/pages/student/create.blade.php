  ...
  <div class="col-xl-12">
    <div class="breadcrumb-holder">
      ...
      <ol class="breadcrumb float-right">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.student.index') }}">{{ __('student.student') }}</a></li>
            ...
            <div class="col-md-6">
              ...
              <div>
                ...
                {{-- <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control datepicker" name="dob" data-date-end-date="0d" autocomplete="off">
